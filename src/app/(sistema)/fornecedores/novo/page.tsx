  ...
  return (
    <div className="max-w-2xl space-y-5">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-4">
        <h2 className="font-semibold text-gray-700">Dados do Fornecedor de Capital</h2>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="number" step="0.01" min="0" className={inputCls} value={form.capitalTotal} onChange={e => set('capitalTotal', e.target.value)} placeholder="500.000,00" />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="email" className={inputCls} value={form.email} onChange={e => set('email', e.target.value)} required placeholder="fornecedor@email.com" />
          </div>
          <div className="col-span-2 pt-3 border-t border-gray-100">
            <label className="block text-xs font-semibold text-gray-600 mb-1">Senha do Portal do Fornecedor</label>
        ...
        <div className="flex gap-3 pt-2">
          <button type="submit" disabled={loading}
            ...
            <Save className="w-4 h-4" /> {loading ? 'Salvando...' : 'Salvar Fornecedor'}
          </button>
